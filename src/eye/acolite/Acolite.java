...
public class Acolite
     ...
     */
    private static final String TOOLTIP = "Simulate Color-impaired Vision with Acolite";
    /**
    ...
    /**
     * Entry point for the Acolite application.
    ...
    public static void main(String[] args) throws IOException {
        ...
        if (GraphicsEnvironment.isHeadless()) {
            System.err.println("Headless mode not supported by Acolite.");
            System.exit(-1);
            return;
        }
        ...
        try {
            ...
            se.printStackTrace();
            Acolite.showErrorMessage("Screenshots are not possible on "
                    + "your system.", true);
            System.exit(-1);
            return;
        }
        ...
        try {
            ...
            Acolite.showErrorMessage("Access to the system tray or "
    ...
    private void initTrayIcon() throws Exception {
        ...
        ImageIcon icon = loadImageIcon(MENUICON, "Acolite Icon");
    ...
    private PopupMenu initMenu() {
        ...
        // exit
        quitMenuItem.setLabel("Exit Acolite");
    ...
    private void simulateAndShow(Image panel) {
        ...
        try {
            ...
            Acolite.showErrorMessage(e.getMessage(), false);
            e.printStackTrace();
        }
    ...
    private void aboutMenuItemActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (this.aboutDialog == null) {
            ...
            aboutDialog.setTitle("About Acolite");
